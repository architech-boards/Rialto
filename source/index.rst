.. JenNode Board by Silica Architech  documentation master file, created by
   sphinx-quickstart on Thu Jul 25 11:13:41 2013.
   You can adapt this file completely to your liking, but it should at least
   contain the root `toctree` directive.

Welcome to JenNode Board by Silica Architech's documentation!
===============================================================
...
| Silica JenNode Board is useful system to evaluate a basic IEE802.15.4 network using JN5168 wireless module. 
| JenNode board has a single built-in USB dongle. Simply switching serial channel from terminal application to programming software, you can perform two alternate functions:
...
*If you want, you can use separate USB-TTL adapter connected with 6 pin strip on JenNode board. In this case, you can have two separate serial channel, first (USBdongle) for programming and second (6 pin strip) for Serial Monitor. See* :ref:`serial`

JenNode board is also designed as a plugin for SerizII board. **JenNode "ready to run" kit** is specially designed for quick use and fast evaluate  network functionallity. All you have to do is plug End-Node on SerizII board, plug Coordinator on PC USB port, start HyperTerminal and enjoy!!

With JenNode board you can evaluate the performance of new NXP SENS300/01 device. The SEN300/01 integrates one high-accuracy temperature sensor, four relative humidity
sensors, six light sensors, a user-writable non-volatile memory and a 10-bit
analog-to-digital converter. JenNode application reads out basic data from temperature, humidity and light sensors. For more information about this sensor, see at NXP official site `NXP official site <http://www.nxp.com/>`_ 

JenNode board integrates a NTAG203F, NFC Forum Type 2 Tag compliant IC with 144 bytes user
...
| Firmware project is included in JenNode_Jennic.zip file.
...
| Install.zip and JenNode_Jennic.zip files can be downloaded from JenNode section of Silica ArchiTech web page (registration needed)
